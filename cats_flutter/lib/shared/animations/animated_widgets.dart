...
class AnimatedGradientButton extends StatefulWidget {
  ...
  const AnimatedGradientButton({
    ...
    this.gradientColors = AppColors.gradientBlueLight,
...
class _AnimatedGradientButtonState extends State<AnimatedGradientButton>
  ...
  void initState() {
    ...
    _scaleAnimation = Tween<double>(begin: 1.0, end: AnimationConstants.pressScale)
        .animate(CurvedAnimation(parent: _controller, curve: AnimationConstants.easeInSmooth));
  }
...
class _AnimatedCardState extends State<AnimatedCard>
  ...
  void initState() {
    ...
    _elevationAnimation = Tween<double>(begin: 2, end: 12)
        .animate(CurvedAnimation(parent: _controller, curve: AnimationConstants.easeOutSmooth));
    _scaleAnimation = Tween<double>(begin: 1.0, end: AnimationConstants.hoverScaleUp)
        .animate(CurvedAnimation(parent: _controller, curve: AnimationConstants.easeOutSmooth));
  }
